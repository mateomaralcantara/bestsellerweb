...
export default function AffiliateEnableForm() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setMessage(`CÃ³digo activo: ${body.code}`); window.location.reload();
  ...
  return <form onSubmit={submit} className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
    ...
    <p className="mt-1 text-sm text-slate-600">Elige un cÃ³digo o dÃ©jalo vacÃ­o para generar uno automÃ¡tico.</p>

      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Publica · vende · escala</p>
          </div>
        </Link>
        ...
        <nav className="hidden items-center gap-2 text-sm text-slate-700 md:flex">
          ...
          <Link
            ...
            aria-label={`Checkout${itemCount > 0 ? ` con ${itemCount} items` : ""}`}
          >
        ...
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-800 transition hover:bg-slate-50 md:hidden"

...
export default function NewBookPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setStatus({
        type: "success",
        message: data.message || "Libro creado correctamente. La muestra visual se genera desde el PDF en el servidor.",
      });
      ...
      {draftRestored ? (
        <div className="flex flex-col gap-3 rounded-3xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900 md:flex-row md:items-center md:justify-between">
          <p>
            ...
            pueden restaurar por seguridad del navegador; vuelve a seleccionarlos.
          </p>
        ...
        <section className={sectionClassName}>
          ...
          <div className="grid gap-4 md:grid-cols-4">
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-2 font-black text-slate-950">Automática</p>
              <p className="mt-1 text-xs leading-5 text-slate-500">
                No se pega introducción ni capítulo manual.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-2 font-black text-slate-950">
                Portada + {PREVIEW_PAGE_COUNT}
              </p>
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Se toman desde el PDF en orden real.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-2 font-black text-slate-950">Doble página</p>
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Horizontal en escritorio, una página en móvil.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-2 font-black text-slate-950">PDF protegido</p>
              <p className="mt-1 text-xs leading-5 text-slate-500">
                El lector ve imágenes, no el archivo completo.
              </p>
            </div>
          </div>
        ...
        <section className={sectionClassName}>
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-3">
            <label className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm font-medium text-slate-700">
              ...
              />
              <span>
                <strong className="block text-slate-900">Activar afiliados</strong>
                Permite comisión por recomendación.
              </span>
            </label>
            ...
            <label className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm font-medium text-slate-700">
              ...
              />
              <span>
                <strong className="block text-slate-900">Destacar en catálogo</strong>
                Mejor visibilidad en listados.
              </span>
            </label>
            ...
            <label className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm font-medium text-slate-700">
              ...
              />
              <span>
                <strong className="block text-slate-900">Permitir descarga</strong>
                Úsalo solo si quieres entregar el PDF.
              </span>
            </label>
          </div>
        </section>
        ...
        <div className="sticky bottom-4 z-10 rounded-[28px] border border-slate-200 bg-white/95 p-4 shadow-2xl shadow-slate-950/10 backdrop-blur">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3 md:ml-auto">
              ...
              >
                {isSubmitting ? "Guardando y generando..." : "Guardar / enviar libro"}
              </button>
            </div>
          </div>
        </div>
